<template>
  ...
  <p><b>1 Группа.</b> Завуалированная жестокость в отношениях к людям, в суждениях о них. Максимально можно набрать 20 баллов. Чем больше баллов, тем отчетливее выражена завуалированная жестокость в отношении к людям.</p>
  <p><b>2 Группа.</b> Открытая жестокость в отношениях к людям. Личность не скрывает и не смягчает свои негативные оценки и переживания по поводу большинства окружающих: выводы о них резкие, однозначные и сделаны, возможно, навсегда. Максимальное число баллов – 45.</p>
  <p><b>3 Группа.</b> Обоснованный негативизм в суждениях о людях. Таковой выражается в объективно обусловленных отрицательных выводах о некоторых типах людей и отдельных сторонах взаимодействия. Максимальное число баллов – 5.</p>
  <p><b>4 Группа.</b> Брюзжание, т.е. склонность делать необоснованные обобщения негативных фактов в области взаимоотношений с партнерами и в наблюдении за социальной действительностью. Максимальное количество баллов — 10.</p>
  <p><b>5 Группа.</b> Негативный личный опыт общения с окружающими. Данный компонент установки показывает, в какой мере вам везло в жизни на ближайший круг знакомых и партнеров по совместной деятельности (в предыдущих показателях оценивались скорее общие ситуации). Максимальное количество баллов – 20.</p>
  <p>Для просчета показателя негативной коммуникативной установки необходимо просчитать полученный суммарный балл. Если полученный балл выше 33, это свидетельствует о наличии выраженной негативной коммуникативной установки.</p>
</div>
    </div>
  </div>
</template>
